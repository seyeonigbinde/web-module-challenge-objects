...
console.log (createMenuItems('pizza', 4, 'lunch'));
console.log (createMenuItems('bread', 1, 'breakfast'));
console.log (createMenuItems('rice', 10, 'dinner'));
...
*/
reviews[8] = {name: "Seye", rating: "4", feedback: "This is making sense now"};
console.log (reviews);
